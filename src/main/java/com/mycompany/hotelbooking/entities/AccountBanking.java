...
public class AccountBanking implements Serializable {
    ...
    private long expiryDateMonth;

    @Column(name = "expiry_date_year")
    private long expiryDateYear;
    ...
    public long getExpiryDateMonth() {
        return expiryDateMonth;
    }

    public void setExpiryDateMonth(long expiryDateMonth) {
        this.expiryDateMonth = expiryDateMonth;
    }

    public long getExpiryDateYear() {
        return expiryDateYear;
    }

    public void setExpiryDateYear(long expiryDateYear) {
